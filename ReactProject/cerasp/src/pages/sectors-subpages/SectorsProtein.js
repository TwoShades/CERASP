  ...
  return (
    <div className="sectors-protein">
      <div className="sectors-protein-content">
        <SubPageHeader name={protein.title[language]} 
        extraContent={
           <div className="about-overview-header-text">
            {language === 'fr' ? (
                <p>
                De nombreuses protéines d'intérêt peuvent être produites par fermentation à partir de microorganismes
                tels que des bactéries, des champignons ou des plantes. La surexpression de ces protéines peut être induite
                par transformation génétique à l’aide de plasmides (bactéries), de protoplastes (champignons) ou
                d’agrobactéries (plantes). Les conditions optimales pour l'extraction et la purification peuvent être atteintes
                en intégrant des solutions économiques et respectueuses de l’environnement, tout en préservant la structure
                et la fonctionnalité de ces protéines. Enfin, leur structure et leur fonctionnalité peuvent être caractérisées
                grâce à notre large gamme d’équipements.
                </p>
                    ) : (
                <p>
